            ...
            <div className="row header mx-5 my-2">
              ...
              <div className="col-2">
                <Link to="/cheques/registrar">
                  <button type="button" className="form-control btn-success">
                    Agregar Cheque
                  </button>
                </Link>
              </div>
            ...
            {this.state.listaCheques.map(cheque => {
              ...
              return (
                <div className="chequeBadge row mx-5 mb-3" key={i - 1}>
                  ...
                  <div className="col-2" name="nombre">
                    {cheque.Nombre}
                  </div>
                  <div className="col-1" name="valor">
                    {cheque.Valor}
                  </div>
                  <div className="col-2" name="concepto">
                    {cheque.Concepto}{" "}
                  </div>
                  <div className="col-1" name="rubro">
                    {cheque.Rubro}
                  </div>
                  <div className="col-2">
